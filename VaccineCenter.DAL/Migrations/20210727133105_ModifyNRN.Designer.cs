...
namespace VaccineCenter.DAL.Migrations
{
    ...
    [Migration("20210727133105_ModifyNRN")]
    partial class ModifyNRN
    {
            ...
            modelBuilder.Entity("VaccineCenter.DAL.Model.InActivity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Closing = new DateTime(2022, 7, 27, 15, 31, 4, 664, DateTimeKind.Local).AddTicks(3439),
                            Opening = new DateTime(2021, 7, 27, 15, 31, 4, 664, DateTimeKind.Local).AddTicks(3068)
                        });
                });
