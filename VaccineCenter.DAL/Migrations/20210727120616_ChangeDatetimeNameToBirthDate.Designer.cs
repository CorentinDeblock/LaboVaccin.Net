...
namespace VaccineCenter.DAL.Migrations
{
    ...
    [Migration("20210727120616_ChangeDatetimeNameToBirthDate")]
    partial class ChangeDatetimeNameToBirthDate
    {
            ...
            modelBuilder.Entity("VaccineCenter.DAL.Model.InActivity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Closing = new DateTime(2022, 7, 27, 14, 6, 16, 124, DateTimeKind.Local).AddTicks(4416),
                            Opening = new DateTime(2021, 7, 27, 14, 6, 16, 124, DateTimeKind.Local).AddTicks(4049)
                        });
                });
